<template>
    ...
    <p v-quando:mouseenter="acaoMouse">Teste mouse event</p>
    <p v-quando:mouseleave="acaoMouseLeave">Teste mouse event</p>
	</div>
</template>
...
export default {
  ...
  methods:{
    ...
    acaoMouse(){
      console.log('Evento de mouseee!!!');
    },
    acaoMouseLeave(){
      console.log('Evento de mouseee Leaaavveeeee!!!');
    }
  }
